...
@@ -112,6 +113,26 @@ const testClients = new Map<string, RegisteredClient>([
...
@@ -2158,4 +2179,546 @@ describe('generated provider HTTP conformance', () => {
     });
   });
